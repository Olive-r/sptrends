...
- probability:
  ...
  Logical. If `TRUE`, bars show percentage of valid cells rather than
...
Invisibly, a named numeric vector with the raw counts (`Positive`,
`Negative`, `Zero`), regardless of `probability`.
