...
Descriptive statistics of the slope raster: how many cells have a valid
estimate, the range and central tendency of the slope values, and what
fraction are increasing, decreasing, or exactly flat.
...
- path:
  ...
  Character or `NULL`. If supplied, the table is written to this CSV
  path.
