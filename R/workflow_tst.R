...
#'     data frame).}
#'   \item{theil_sen}{The output of [slope_estimator()], or `NULL` if
#'     `theil_sen = FALSE`. Not smoothed by default (see the
#'     `theil_sen_args` note above) -- check `theil_sen_smoothed` if you
#'     need to know whether it was (e.g. because you set it yourself).}
