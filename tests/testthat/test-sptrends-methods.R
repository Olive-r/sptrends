...
test_that("spatial_autocorrelation_summary()/spatial_autocorrelation_null_plot()/plot_detection_comparison()/classify_moran()/workflow_summary()/direction_map() are no longer part of the public API", {
  exported <- getNamespaceExports("sptrends")
