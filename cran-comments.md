...
* Local: `devtools::check()` run directly against 0.97.1: 0 errors,
  0 warnings, 0 notes (15 minutes 56.3 seconds).
  `covr::package_coverage()`: 100.00% overall and 100.00% for every R
  source file. Confirms the 0.97.1 URL fix introduced no regressions.
...
Most recent completed local check, against 0.97.1: 0 errors, 0 warnings,
0 notes.
